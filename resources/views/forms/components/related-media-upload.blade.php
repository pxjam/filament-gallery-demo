...
>
    ...
    {{ ($this->getEditMediaAction())(['mediaId' => 3])->label('Edit Media with id 3') }}
    {{ ($this->getEditMediaAction())(['mediaId' => 4])->label('Edit Media with id 4') }}
        ...
        x-data="fileUploadFormComponent({
                    fileActionButtons: {
                        customButton: {
                            label: 'Custom',
                            onClick: (file) => {
                                console.log('Custom button clicked for file:', file);
                            },
                        },
                    },
